...
var tests = new (string Name, Action Body)[]
{
    ...
    ("Marisa per-star mass is independent and quantity adds damage", MarisaGrowthTests.Mass),
    ("Marisa tears continuously and retargets without renewed life", MarisaGrowthTests.Sustain),
    ("Marisa groups are bounded and freeze with choices", MarisaGrowthTests.Lifecycle),
    ("Marisa massive targets attract stars within finite range", MarisaGrowthTests.Targeting),
    ("Marisa crowd budget never starves its primary target", MarisaGrowthTests.CrowdedTarget),
    ("Marisa planet attraction is capped with boss resistance", MarisaGrowthTests.Planet),
