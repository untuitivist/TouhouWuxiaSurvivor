...
local outputSource = app.params["source"] or project .. "/art/title/moonlit_shrine.aseprite"
local outputTexture = app.params["texture"] or project .. "/assets/ui/title/moonlit_shrine.png"
