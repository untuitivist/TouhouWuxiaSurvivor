...
var assets = new Dictionary<string, PixelCanvas>
{
    ...
    ["menu_entry_normal.png"] = menu.PaintEntry(UiControlState.Normal),
    ["menu_entry_hover.png"] = menu.PaintEntry(UiControlState.Hover),
    ["menu_entry_pressed.png"] = menu.PaintEntry(UiControlState.Pressed),
    ["menu_entry_disabled.png"] = menu.PaintEntry(UiControlState.Disabled),
    ["menu_entry_focus.png"] = menu.PaintFocus(),
    ["role_plaque.png"] = menu.PaintRolePlaque(),
