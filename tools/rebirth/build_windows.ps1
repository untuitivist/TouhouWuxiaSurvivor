...
$paths = @('game', 'assets/aseprite/shrine-v04', 'assets/fonts', 'assets/internal_original/base/audio', 'project.godot', 'export_presets.cfg', 'TouhouWuxiaSurvivor.csproj', 'TouhouWuxiaSurvivor.sln', 'CHANGELOG.md')
