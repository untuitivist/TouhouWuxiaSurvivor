...
public partial class GameCanvas
{
    ...
    private void DrawHud()
    {
        ...
        Text(Run.Build.SignatureUnlocked ? GameText.Get("擦弹蓄势 · 满槽自动清弹") : GameText.Get("梦想封印 · 尚未解锁"), new(989, 77), 14, Palette.Muted);
        ...
        if (Run.Time < 10)
        {
            ...
            CenterText(Run.Hero == HeroKind.Reimu ? GameText.Get("基础御札起步，修习解锁阵与玉。") : GameText.Get("星弹开路，魔炮锁向。"), new(640, 578), 20, Palette.Paper, TitleFont);
